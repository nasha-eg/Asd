...
const CertificatePreview: React.FC<CertificatePreviewProps> = ({ data }) => {
  ...
  const SharedFooter = () => (
    <div className="w-full mt-auto shrink-0 pb-1" dir="ltr">
      {/* Full Official Footer Grid - Now restored to all pages as per the original document standard */}
      <div className="grid grid-cols-4 border border-black text-[7.5px] mb-2 font-bold">
        ...
        <div className="col-span-1 relative">
          ...
          <div className="h-14 flex flex-col items-center justify-center p-2 text-center font-black font-cairo text-[9px] relative">
            {data.officerSignature && <img src={data.officerSignature} className="absolute inset-0 m-auto max-h-[80%] opacity-80 mix-blend-multiply" />}
      ...
      <div className="flex justify-between items-end gap-3 px-1">
        ...
        <div className="text-right flex-1 flex flex-col items-end">
          <p className="text-[7px] font-bold text-slate-600 mb-1 leading-tight max-w-[340px] font-cairo">
            {labels.disclaimerAr}
  ...
  return (
    <div className="flex flex-col gap-6 items-center bg-slate-200 py-6 print:bg-white print:py-0 print:gap-0" dir="ltr">
      {/* Page 1: Main Certificate */}
      <div className="bg-white w-[210mm] h-[297mm] px-10 py-8 flex flex-col certificate-page relative overflow-hidden print:shadow-none shadow-xl">
        <PageHeader />
        ...
        <div className="grid grid-cols-2 border border-black mb-2">
          <div className="border-r border-black">
            ...
            <div className="p-2 text-center text-[12.5px] font-black uppercase font-inter leading-tight">{data.fromOrg}</div>
          </div>
          <div>
            <div className="bg-slate-100 p-0.5 text-center font-black border-b border-black text-[8px] font-cairo" style={{ backgroundColor: '#f1f5f9', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
            ...
            <div className="p-2 text-center text-[12.5px] font-black uppercase font-inter leading-tight">{data.toOrg}</div>
          </div>
        </div>
