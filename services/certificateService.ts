...
import { CertificateData, CertificateLabels, GlobalBranding } from '../types';

const STORAGE_KEY = 'uae_phytosanitary_certs_v8_final';
const BRANDING_KEY = 'uae_portal_branding_v1';
...
export const DEFAULT_BRANDING: GlobalBranding = {
  ...
  partnerLogo1: 'https://i.ibb.co/3ykXWHz/abu-dhabi-police.png',
  partnerLogo2: 'https://i.ibb.co/Wc63DHz/skgep.png',
  partnerLogo3: 'https://i.ibb.co/L5h8nLz/esaad.png',
